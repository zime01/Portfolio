  ...
  return (
    <div>
      <div className="my-0 mx-auto max-w-[62.5rem] flex items-center  justify-between mt-12 pb-16 h-[75vh]  border-b-2 border-[var(--color-btn-primary)] ">
        <div className="">
          <h1 className="text-[var(--color-text-primary)] text-3xl mb-3">
            Hello:)
          </h1>
          <p className="text-[var(--color-text-primary)] text-3xl mb-3">
            I'am{" "}
            <span className="text-[var(--color-text-h)] font-semibold">
              Hazim Zimić
            </span>
          </p>
          <p className="text-3xl text-[var(--color-text-h)]">
            Front end developer
          </p>
        </div>
        <div className="">
      ...
      <div className="my-0 mx-auto max-w-[62.5rem] flex items-center justify-between gap-20 pt-16 mt-16 mb-32">
        <div className="">
          <h1 className="uppercase  text-[var(--color-text-primary)] text-3xl mb-10">
            let me{" "}
            <span className="text-[var(--color-text-h)] font-semibold">
              introduce
            </span>{" "}
          ...
          <p className="text-[var(--color-text-primary)] text-lg pb-3">
      ...
      <div className="text-center">
        <p className="text-[var(--color-text-h)] text-3xl pb-4 font-semibold">
          Find me on
        </p>
